...
// const mask = new Mask(3)

// const nx0 = new Not(x0, mask);
// const ax01 = new And(x0, x1);
// const ox01 = new Or(x0, x1);
// const xx01 = new Xor(x0, x1);
// const ix01 = new Imp(x0, x1, mask);
// const eq01 = new Eq(x0, x1, mask);
// const nx01 = new Nor(x0, x1, mask);
// const nax01 = new Nand(x0, x1, mask);

// console.log(x0.vecToString(), x1.vecToString(), mask.vecToString());
...
console.log(new TableTruth(5, [Not, And, Or, Xor, Imp, Eq, Nor, Nand]).toString());
